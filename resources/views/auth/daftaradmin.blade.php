@extends('layout.main')
@section('container')
    <div class="page-wrapper mt-lg-5 mb-lg-5" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
