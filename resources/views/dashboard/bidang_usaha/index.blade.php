...
@section('container')
    ...
    <div class="modal fade" id="tambahBidang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hid_bdng_ushen="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('admin.bidang_usaha.store') }}" autocomplete="off">
                    @csrf
                    <div class="modal-body">
                        <div class="form-floating mb-1">
                            ...
                            <label for="nama">Nama Bidang Usaha</label>
                            @error('nama')
