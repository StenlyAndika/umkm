...
return [
    ...
    */
    ...
    'middleware' => [
        ...
        'autoClose' => env('SWEET_ALERT_MIDDLEWARE_AUTO_CLOSE'),

        'toast_position' => env('SWEET_ALERT_MIDDLEWARE_TOAST_POSITION'),

        'toast_close_button' => env('SWEET_ALERT_MIDDLEWARE_TOAST_CLOSE_BUTTON', true),

        'timer' => env('SWEET_ALERT_MIDDLEWARE_ALERT_CLOSE_TIME'),
